    ...
    <section className="w-full py-16">
      <div className="max-w-8xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-10 mb-10">
          {/* LEFT BIG CARD */}
          <GlowCard className="bg-[#e6e6e6] rounded-3xl md:rounded-[45px] border-2 border-[#e2e3e2] shadow-[0_15px_40px_rgba(0,0,0,0.08)]">
            <div className="p-10 flex">
              {/* Phone mockup */}
              <div className="hidden md:block relative w-full h-[160px] mb-6 flex items-center justify-center md:absolute md:left-6 md:top-[60%] md:-translate-y-1/2 md:w-[260px] md:h-[340px] md:mb-0 overflow-hidden">
                <img
                  src={appMockup}
                  alt="Mobile App"
          ...
          {/* RIGHT SMALL CARD */}
          <GlowCard className="rounded-[36px] bg-[#e6e6e6] shadow-[0_20px_50px_rgba(0,0,0,0.08)]">
            <div className="p-10 relative h-full">
              {/* PURPLE CIRCLE GLOW */}
              <div className="pointer-events-none absolute -bottom-45 -left-30 w-[380px] h-[380px] rounded-full bg-[#4b2e83]/25 blur-[80px]" />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[40%_57%] gap-10">
          {/* BOTTOM LEFT – 30% */}
          <GlowCard className="rounded-[36px] bg-[#f3f1f8] shadow-[0_20px_50px_rgba(0,0,0,0.08)]">
            <div className="p-10 relative h-full">
              {/* SOFT PURPLE GLOW */}
          ...
          {/* BOTTOM RIGHT – 70% */}
          <GlowCard className="rounded-[36px] border-2 border-[#e2e3e2] bg-[#e6e6e6] shadow-[0_20px_50px_rgba(0,0,0,0.08)]">
            <div className="p-10">
